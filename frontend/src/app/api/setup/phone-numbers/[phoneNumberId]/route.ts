...
export async function PUT(request: Request, context: { params: Promise<{ phoneNumberId: string }> }) {
  try {
    ...
    const response = await fetch(`${process.env.API_BASE_URL}/practices/${practice.id}/phone-numbers/${phoneNumberId}`, {
      method: "PUT",
